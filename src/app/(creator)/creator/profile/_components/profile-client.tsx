...
const TABS = [
  ...
  { key: "activity", label: "Activity", icon: "chart" },
  { key: "balance", label: "Balance", icon: "wallet" },
  { key: "community", label: "Community", icon: "discord" },
] as const;

export function ProfileClient({ initialTab, profileData, balanceData, activityDays }: ProfileClientProps) {
  ...
  return (
    <div className="flex p-6 gap-6 w-full">
      ...
      <div className="flex-1 min-w-0">
        ...
        {activeTab === "activity" && <ActivityHeatmap days={activityDays} />}
