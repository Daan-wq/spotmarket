...
import { OAUTH_DISCLOSURES } from "@/lib/oauth-disclosures";
import { PermissionDisclosureModal } from "@/components/oauth/permission-disclosure-modal";
...
// is now an OAuth-only connect card with a permission disclosure modal.
...
export function BioVerifyCard({
  ...
  const disclosure = OAUTH_DISCLOSURES[platform];
