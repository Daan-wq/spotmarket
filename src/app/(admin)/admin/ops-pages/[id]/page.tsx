...
import { PageOwnershipPanel } from "@/components/admin/PageOwnershipPanel";
...
export default async function AdminPageDetailPage({
  ...
  return (
    <div className="p-8 max-w-5xl">
      <Link href="/admin/ops-pages" className="text-sm mb-4 inline-block" style={{ color: "var(--text-secondary)" }}>
        ← Back to Pages
      </Link>
      ...
      {/* Ownership & Contract */}
      <PageOwnershipPanel
        operatorName={page.operatorName}
        operatorEmail={page.operatorEmail}
        contractStatus={page.contractStatus}
        contractSignedAt={page.contractSignedAt}
        copyrightAssigned={page.copyrightAssigned}
        trademarkBOIP={page.trademarkBOIP}
        trademarkRef={page.trademarkRef}
        credentialVaultId={page.credentialVaultId}
        contentBacklogDays={page.contentBacklogDays}
        tierLevel={page.tierLevel}
        replacementReady={page.replacementReady}
        noticePeriodDays={page.noticePeriodDays}
      />
