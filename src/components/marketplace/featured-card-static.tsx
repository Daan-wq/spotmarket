...
export function FeaturedCardStatic({ campaign, applyHref, applyLabel }: FeaturedCardStaticProps) {
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-end">
          ...
          >
            ...
            <a
              href={applyHref}
              className="block w-full py-3 rounded-lg text-sm font-semibold text-black text-center transition-opacity"
