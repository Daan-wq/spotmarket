...
export interface NotificationData {
  ...
  APPLICATION_REJECTED: { applicationId: string; campaignName: string; rejectionNote?: string };
  DEMOGRAPHICS_VERIFIED: { submissionId: string; tiktokHandle: string };
  DEMOGRAPHICS_REJECTED: { submissionId: string; tiktokHandle: string; rejectionNote?: string };
